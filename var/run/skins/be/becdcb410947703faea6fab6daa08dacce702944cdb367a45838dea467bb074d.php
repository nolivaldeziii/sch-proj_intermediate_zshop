...
/*  #}*/
/* */
/* {{ widget('\\XLite\\View\\FormField\\Textarea\\Simple', value=this.zone.getZoneZipCodes(1), label='Zip/postal code masks', rows='5', cols='70', fieldName='zone_zipcodes', help=t('Zone zipcode masks help')) }}*/
/* */
