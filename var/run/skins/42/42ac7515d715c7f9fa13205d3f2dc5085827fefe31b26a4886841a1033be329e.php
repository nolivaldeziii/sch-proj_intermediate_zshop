...
<li class=\"import-mode-option\">
  ";
        // line 8
        echo XLite\Core\Templating\Twig\Extension\xcart_twig_escape_filter($this->env, call_user_func_array($this->env->getFunction('widget')->getCallable(), array($this->env, $context, array(0 => "\\XLite\\View\\FormField\\Select\\Regular", "fieldName" => "options[updateOnly]", "fieldId" => "importMode", "label" => call_user_func_array($this->env->getFunction('t')->getCallable(), array("Import mode")), "value" => $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["this"]) ? $context["this"] : null), "config", array()), "Import", array()), "updateOnly", array()), "options" => $this->getAttribute((isset($context["this"]) ? $context["this"] : null), "getImportModeOptions", array(), "method")))), "html", null, true);
        echo "
  ";
        // line 9
...
/* */
/* <li class="import-mode-option">*/
/*   {{ widget('\\XLite\\View\\FormField\\Select\\Regular', fieldName='options[updateOnly]', fieldId='importMode', label=t('Import mode'), value=this.config.Import.updateOnly, options=this.getImportModeOptions()) }}*/
