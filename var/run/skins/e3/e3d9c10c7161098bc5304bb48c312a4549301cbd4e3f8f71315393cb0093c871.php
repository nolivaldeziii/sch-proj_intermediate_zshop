...
";
    ...
    ";
            ...
            if ( !$this->getAttribute($this->getAttribute((isset($context["this"]) ? $context["this"] : null), "product", array()), "isOutOfStock", array(), "method")) {
                // line 10
                echo "      ";
                if ($this->getAttribute((isset($context["this"]) ? $context["this"] : null), "isGotoProduct", array(), "method")) {
                    // line 11
                    echo "        ";
                    echo XLite\Core\Templating\Twig\Extension\xcart_twig_escape_filter($this->env, call_user_func_array($this->env->getFunction('widget')->getCallable(), array($this->env, $context, array(0 => "\\XLite\\View\\Button\\Link", "label" => "Add to cart", "style" => ("regular-main-button add2cart add-to-cart link productid-" . $this->getAttribute($this->getAttribute((isset($context["this"]) ? $context["this"] : null), "product", array()), "product_id", array())), "location" => $this->getAttribute($this->getAttribute((isset($context["this"]) ? $context["this"] : null), "product", array()), "url", array())))), "html", null, true);
                    echo "
      ";
                } else {
                    // line 13
...
";
    ...
    {
        return array (  47 => 16,  44 => 15,  38 => 13,  32 => 11,  29 => 10,  27 => 9,  24 => 8,  22 => 7,  19 => 6,);
    }
}
/* {##*/
...
/*         {{ widget('\\XLite\\View\\Button\\Link', label='Add to cart', style='regular-main-button add2cart add-to-cart link productid-' ~ this.product.product_id, location=this.product.url) }}*/
/*       {% else %}*/
