...
<div class=\"products\">
  ...
  <table class=\"products-table\" cellspacing=\"0\">
    ...
    ";
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute((isset($context["this"]) ? $context["this"] : null), "order", array()), "getItems", array(), "method"));
...
/*     </tr>*/
/* */
/*     {% for item in this.order.getItems() %}*/
