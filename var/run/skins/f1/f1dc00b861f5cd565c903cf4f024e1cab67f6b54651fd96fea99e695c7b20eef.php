...
<div class=\"incompatible-module-list-description\">
  ";
        // line 8
        echo XLite\Core\Templating\Twig\Extension\xcart_twig_escape_filter($this->env, call_user_func_array($this->env->getFunction('t')->getCallable(), array("Please contact the module developers to make sure that these modules are compatible with the upcoming upgrade")), "html", null, true);
        echo "
</div>
";
        // line 10
...
/* */
/* <div class="incompatible-module-list-description">*/
/*   {{ t('Please contact the module developers to make sure that these modules are compatible with the upcoming upgrade') }}*/
/* </div>*/
