...
<h2>";
        // line 9
        echo XLite\Core\Templating\Twig\Extension\xcart_twig_escape_filter($this->env, call_user_func_array($this->env->getFunction('t')->getCallable(), array("Default image settings")), "html", null, true);
        echo "</h2>
...
/*  #*/
/*  # @ListChild (list="images_settings", weight="10")*/
/*  #}*/
/* */
/* <div class="images-sizes">*/
/* */
