...
class Method extends \XLite\Model\Payment\Method implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'method_id', 'service_name', 'class', 'moduleName', 'orderby', 'adminOrderby', 'enabled', 'moduleEnabled', 'added', 'type', 'settings', 'fromMarketplace', 'iconURL', 'countries', 'exCountries', 'editLanguage', 'translations');
        }
