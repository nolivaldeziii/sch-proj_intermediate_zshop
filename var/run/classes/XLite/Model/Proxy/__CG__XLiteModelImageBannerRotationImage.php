...
class BannerRotationImage extends \XLite\Model\Image\BannerRotationImage implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'bannerRotationSlide', 'alt', 'width', 'height', 'hash', 'needProcess', 'id', 'path', 'fileName', 'mime', 'storageType', 'size', 'date', 'loadError', 'loadErrorMessage');
        }
