...
class AttributeValueSelect extends \XLite\Model\AttributeValue\AttributeValueSelect implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'attribute_option', 'priceModifier', 'priceModifierType', 'weightModifier', 'weightModifierType', 'defaultValue', 'id', 'product', 'attribute', 'editLanguage', 'translations');
        }
