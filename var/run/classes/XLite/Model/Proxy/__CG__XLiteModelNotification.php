...
class Notification extends \XLite\Model\Notification implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'templatesDirectory', 'availableForAdmin', 'availableForCustomer', 'enabledForAdmin', 'enabledForCustomer', 'adminHeaderEnabled', 'adminGreetingEnabled', 'adminSignatureEnabled', 'customerHeaderEnabled', 'customerGreetingEnabled', 'customerSignatureEnabled', 'editLanguage', 'translations');
        }
