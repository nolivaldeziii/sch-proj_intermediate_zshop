...
class Product extends \XLite\Model\Product implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'xcPendingBulkEdit', 'auctionIncData', 'freeShip', 'freightFixedFee', 'upsellingProducts', 'upsellingParentProducts', 'reviews', 'reviewAddedByUser', 'votesCount', 'reviewsCount', 'averageRating', 'tabs', 'participateSale', 'discountType', 'salePriceValue', 'views_stats', 'purchase_stats', 'ogMeta', 'useCustomOG', 'featuredProducts', 'product_id', 'price', 'sku', 'enabled', 'weight', 'useSeparateBox', 'boxWidth', 'boxLength', 'boxHeight', 'itemsPerBox', 'free_shipping', 'taxable', 'javascript', 'arrivalDate', 'date', 'updateDate', 'needProcess', 'categoryProducts', 'order_items', 'images', 'inventoryEnabled', 'amount', 'lowLimitEnabledCustomer', 'lowLimitEnabled', 'lowLimitAmount', 'productClass', 'taxClass', 'attributes', 'attributeValueC', 'attributeValueT', 'attributeValueS', 'attrSepTab', 'sold', 'quickData', 'attrValues', 'memberships', 'cleanURLs', 'metaDescType', 'sales', 'xcPendingExport', 'editLanguage', 'translations', 'entityVersion');
        }
