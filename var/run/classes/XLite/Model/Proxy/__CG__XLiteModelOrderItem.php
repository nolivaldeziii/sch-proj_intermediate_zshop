...
class OrderItem extends \XLite\Model\OrderItem implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'capostParcelItems', 'capostReturnItems', 'xpcFakeItem', 'shippingCost', 'item_id', 'object', 'name', 'sku', 'price', 'itemNetPrice', 'discountedSubtotal', 'amount', 'order', 'surcharges', 'dumpProduct', 'attributeValues', 'total', 'subtotal');
        }
