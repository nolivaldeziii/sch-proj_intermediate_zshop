...
class Coupon extends \XLite\Module\CDev\Coupons\Model\Coupon implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'code', 'enabled', 'value', 'type', 'comment', 'uses', 'dateRangeBegin', 'dateRangeEnd', 'totalRangeBegin', 'totalRangeEnd', 'usesLimit', 'usesLimitPerUser', 'singleUse', 'productClasses', 'memberships', 'usedCoupons', 'categories');
        }
