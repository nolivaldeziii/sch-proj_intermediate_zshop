...
class SpecialOffer extends \XLite\Module\QSL\SpecialOffersBase\Model\SpecialOffer implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'offer_id', 'offerType', 'name', 'position', 'enabled', 'activeFrom', 'activeTill', 'exclusions', 'image', 'promoHome', 'promoOffers', 'editLanguage', 'translations');
        }
