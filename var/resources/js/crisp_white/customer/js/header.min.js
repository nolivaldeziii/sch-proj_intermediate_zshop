...
function materializeMinicart(){var viewportWidth=Math.max(document.documentElement.clientWidth,window.innerWidth||0);if(viewportWidth<993){switchMinicarts('.mobile_header .lc-minicart-placeholder')}else if($('.desktop-header').find('.lc-minicart').length<1)switchMinicarts('.desktop-header .lc-minicart-placeholder')}
